...
import java.awt.*;
class C_Quiz extends JFrame implements ItemListener , ActionListener{
    ...
    String ques[] = {"1. Who invented C Programming?" , "2 . C is Which type of language ? " ,
            "3. Number of Keywords in C programming?" , "4. malloc() and calloc() are which functions?",
            "5. Which one of the following is not a C Feature?" , "6. Which of these cannot be used for a variable name in Java?",
            "7. What is the extension of C sourcecode files?" , "8. Which of the following is not concept of C?",
            "9. What is pointer in C programming? ", "10. Which of following loop is not supported in C?",
            "11. Which of the following is not a String function?","12. Which of following keyword is used to break execution?",
            "13.  Which one of the following is not supported in C?","14. What is the approach of C Programming?",
            "15. Which one of the following is a not header file in C?"

    };

    String r11[] = {" Guido van Rossum" , " OOP Language " , " 35" , " String Functions",
            " Procedure Oriented" , "  switch" , "  .txt" ," Structure and Union", " Memory allocation operator" , " forEach()" , " strrev()", " break",
            " Condition Making"," Bottom-Up Approach"," <stdlib.h> "
    };


    String r22[] = {" James Gosling" , " POP Language " , " 36" , " Memory Allocation Functions",
            " Multi-Threading" , " variable" , " .class" , " Inheritence", " User-defined data type", " while()", " strlen()"," void",
            " Method OverLoading"," Scripting Approach"," <value.h>"
    };


    String r33[] = {" Dennis Ritchie" , " Simple Language " , " 32" , " Math Functions",
            "  User-Friendly", " break " , " .c" , " File Management", " variable which stores address of another variable", " for()", " strclp()", " struct",
            " Looping"," Top-Down Approach"," <conio.h>"
    };
    ...
    JLabel L2 = new JLabel(" Quiz For C Programing",quiz,SwingConstants.LEFT);
        ...
        if(r1.isSelected() || r2.isSelected() || r3.isSelected())
        {
            ...
            if(changeq==15)
            {
                ...
                try
                {
                    ...
                    String update="UPDATE quiz_user SET c=? WHERE password=?";
